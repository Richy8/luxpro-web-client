...
const TextInputField = ({
  ...
  const getInputTypeView = () => {
    const typeView = {
      ...
      search: "has-prefix",
      password: "has-suffix",
      date: "has-date-prefix",
      time: "has-date-prefix",
        ...
        {!isTextArea ? (
          <>
            ...
            {inputType === IInputType.Date && (
              <div className="prefix-date-item" onClick={handleIconClick}>
                {/* <CalendarDaysIcon className="prefix-date-icon" /> */}
                <div className="date-icon icon-calendar-add"></div>
              </div>
            )}
            ...
            {inputType === IInputType.Time && (
              <div className="prefix-date-item" onClick={handleIconClick}>
                <ClockIcon className="prefix-date-icon" />
              </div>
            )}
          </>
        ) : (
